...
Check out the [github repo](https://github.com/colinquirk/LetsExploreStatistics) if you are interested in seeing how it works under the hood. The short version is that the book itself is written in using the R packaage bookdown, whereas the interactive elements are created with javascript and D3.js.